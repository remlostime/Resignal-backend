...
const interviewRoutes = async (server) => {
    ...
    const interviewContextRepository = new NeonInterviewContextRepository();
    ...
    server.get("/", { preHandler: [authenticate] }, async (request, reply) => {
        ...
        const { page: pageParam, page_size: pageSizeParam } = request.query;
    ...
    server.get("/:id", { preHandler: [authenticate] }, async (request, reply) => {
        ...
        try {
            ...
            const feedback = context.contextJson;
            return {
