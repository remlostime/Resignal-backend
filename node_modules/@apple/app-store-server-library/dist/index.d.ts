...
import { GetImageListResponse } from './models/GetImageListResponse';
import { GetMessageListResponse } from './models/GetMessageListResponse';
...
import { AppTransactionInfoResponse } from './models/AppTransactionInfoResponse';
...
export declare class AppStoreServerAPIClient {
    ...
    protected makeRequest<T>(path: string, method: string, queryParameters: {
        [key: string]: string[];
    }, body: object | Buffer | null, validator: Validator<T> | null, contentType?: string): Promise<T>;
    protected makeFetchRequest(path: string, parsedQueryParameters: URLSearchParams, method: string, requestBody: string | Buffer | undefined, headers: {
        [key: string]: string;
     ...
     */
    setAppAccountToken(originalTransactionId: string, updateAppAccountTokenRequest: UpdateAppAccountTokenRequest): Promise<void>;
    /**
     ...
     */
    uploadImage(imageIdentifier: string, image: Buffer): Promise<void>;
    /**
     ...
     */
    deleteImage(imageIdentifier: string): Promise<void>;
    /**
     ...
     */
    getImageList(): Promise<GetImageListResponse>;
    /**
     ...
     */
    uploadMessage(messageIdentifier: string, uploadMessageRequestBody: UploadMessageRequestBody): Promise<void>;
    /**
     ...
     */
    deleteMessage(messageIdentifier: string): Promise<void>;
    /**
     ...
     */
    configureDefaultMessage(productId: string, locale: string, defaultConfigurationRequest: DefaultConfigurationRequest): Promise<void>;
    /**
     ...
     */
    deleteDefaultMessage(productId: string, locale: string): Promise<void>;
    /**
      ...
      */
    getAppTransactionInfo(transactionId: string): Promise<AppTransactionInfoResponse>;
